  ...
  return (
    <header className="h-20 px-4 sm:px-6 lg:px-10 bg-white/80 backdrop-blur-md border-b border-gray-100 flex items-center justify-between sticky top-0 z-10 shrink-0">
      ...
      <div className="flex items-center gap-2">
        ...
        <button onClick={logout} className="relative p-2.5 text-gray-400 hover:text-gray-900 hover:bg-gray-50 rounded-full transition-colors" title="Logout">
          <LogOut size={20} />
        </button>
        ...
        <div className="hidden sm:flex items-center gap-3 pl-6 border-l border-gray-200">
          ...
          <div className="w-10 h-10 rounded-full bg-indigo-100 border-2 border-white flex items-center justify-center text-indigo-600 font-semibold overflow-hidden shadow-sm">
