...
const CourseCard = ({ course }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-50 to-white rounded-2xl shadow-xl p-6 border border-indigo-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1" onClick={()=>{router.push(`/dashboard/course/${course._id}`)}}>
      {/* Course Code Badge */}
